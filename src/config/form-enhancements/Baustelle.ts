// Auto-generated. Per-entity form-enhancements config for "Baustelle".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['name', 'adresse', 'bauleiter', 'status'],
  defaults: {
    'status': { kind: 'lookup', key: 'in_planung', label: 'In Planung' },
  },
  computed: {},
};
